...
alias docker-vm-shell='docker run -it --privileged --pid=host debian nsenter -t 1 -m -u -n -i bash'
...
alias gcp!="git commit -s --amend --no-edit && git push --force-with-lease"
alias gcp="git cherry-pick -s"
alias gcpa="git cherry-pick --abort"
alias gcpc="git cherry-pick -s --continue"
alias gcl='git branch -vv | fgrep ": gone]" | awk '\''{ print $1 }'\'' | xargs -n 1 git branch -D'
alias gd="git diff"
...
alias grc="git rebase --signoff --continue"
alias grm="git rebase --signoff main"
alias grim="git rebase --signoff -i main"
alias grmm="git rebase --signoff master"
alias grimm="git rebase --signoff -i master"
alias grs="git reset"
alias grsh="git reset --hard"
alias gres="git restore -SW"
alias gress="git restore -S"
alias gresw="git restore -W"
