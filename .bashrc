...
alias rsdiffd='sudo rsnapshot-diff -v /media/Damyan/mail/daily.0/ /media/Damyan/mail/daily.1 | less'
alias rsdiffw='sudo rsnapshot-diff -v /media/Damyan/melnik/weekly.0/ /media/Damyan/melnik/weekly.1 | less'
alias rsdiffm='sudo rsnapshot-diff -v /media/Damyan/monthly.0/ /media/Damyan/monthly.1 | less'
